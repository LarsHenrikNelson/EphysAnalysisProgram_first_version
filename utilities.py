...
#     string_components = data_string.split('\r')
#     _, epoch = string_components[1].split(r'=')
#     analog_input = matfile1[name]['UserData']['ai']
#     time_stamp = matfile1[name]['timeStamp']
#     if analog_input == 0:
#         pulse_pattern = string_components[39].split(r'=')[1]
#         ramp = string_components[22].split(r';')[7].split(r'=')[1]
#         pulse_amp = string_components[22].split(r';')[0].split(r'=')[2]
#     elif analog_input == 1:
#         pulse_pattern = string_components[40].split(r'=')[1]
#         ramp = string_components[23].split(r';')[7].split(r'=')[1]
#         pulse_amp = string_components[23].split(r';')[0].split(r'=')[2]
